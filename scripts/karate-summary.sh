...
<tr>
  <th style='border:1px solid #000;'>Total Features</th>
  <th style='border:1px solid #000;'>Total Scenarios</th>
  <th style='border:1px solid #000;'>Passed</th>
  <th style='border:1px solid #000;'>Failed</th>
</tr>
<tr>
  <td style='border:1px solid #000;'>$total_features</td>
  <td style='border:1px solid #000;'>$total_scenarios</td>
  <td style='border:1px solid #000;'>$passed</td>
  <td style='border:1px solid #000;'>$failed</td>
</tr>
</table>"
